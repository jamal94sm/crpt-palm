...
BASELINE_SPECS = [
    ...
    {"key": "byol", "name": "BYOL",                  "script": "byol",
     "extra": []},
    {"key": "barlowtwins", "name": "Barlow Twins",   "script": "barlowtwins",
     "extra": []},
...
def get_cfg(args=None):
    ...
    p.add_argument("--maskfeat_script_path", type=str,
        default="maskfeat-palm/main.py",
        help="Path to maskfeat-palm's main.py. Only used with --run_all_baselines 1.")
    ...
    p.add_argument("--barlowtwins_script_path", type=str,
        default="barlowtwins-palm/main.py",
